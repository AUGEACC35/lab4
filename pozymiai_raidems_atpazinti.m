...
figure(12), imshow(V)
%% Raidziu iskirpimas ir sudeliojimas uz kintamojo 'objektai' celes |
...
% kadangi ribu  nusako 4 koordinates, pergrupuojame reiksmes
...
% kadangi centru  nusako 2 koordinates, pergrupuojame reiksmes
...
% surusiojami objektai pagal x koordinatu¦ - stulpeluz
% arrange objects according to the column number
O_centras = sortrows(O_centras,2);
% rusiojama atsizvelgiant uz pavyzdziu eiluciu ir raidziu skaiciu
...
% vaizdo fragmentai apkerpami, panaikinant fonu  is krastu (pagal staciakampuz)
...
for k = 1:Skaicius % Skaicius = 88, jei yra 88 raides
    ...
    % apskaiciuokime kiekvieno stulpelio sumu 
...
for k=1:Skaicius
    ...
    % padalinkime vaizdo fragmentu  uz 10x10 dydzio dalis
    % divide each image into 10x10 size segments
    for m=1:7
        for n=1:5
            % apskaiciuokime kiekvienos dalies vidutinuz sviesumu  
    ...
    % issaugome apskaiciuotus pozymius uz bendru  kintamu juz
